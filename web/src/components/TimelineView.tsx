...
// bars along a 24h axis, filler dim, with a live "now" marker.
export default function TimelineView({ playout }: { playout: Playout }) {
  ...
  return (
    <div ref={scrollRef} className="overflow-x-auto rounded-lg border border-slate-800 bg-slate-950/40">
      <div className="relative" style={{ width: totalMin * PX, height: 92 }}>
        {/* hour ticks */}
